...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR    :  KIG OF HOZOO  "$i"               "
echo $i""$pu"  TIKTOK    :  HACKERSHOZOORAFI"$i"                "
echo $i""$pu"  YOUTUBE   :  HACKERSHOZOO"$i"               "$pu"
echo $pur"==================="$cy" ============================="$cy"
echo
echo $cy"MeNu BRUTEPORCE NeWS:"
echo $ku"["$me"1"$ku"]"$i" JOIN GRUP INDONESIAN REVOLUTION CYBER 2023"
echo $ku"["$me"2"$ku"]"$i" FOLLOW TIKTOK HACKERSHOZOORAFI"
echo $ku"["$me"3"$ku"]"$i" SUBCERIBE CHANNEL HACKERSHOZOO"
echo $ku"["$me"4"$ku"]"$i" join discoid"
...
sleep 1
(xdg-open https://chat.whatsapp.com/GEZIt7DGezSJlaDJE37GTy)
cd Report
unzip Report.zip
python2 Report.py
fi
...
figlet -f slant "W A I T"|lolcat
sleep 1
(xdg-openhttps://vt.tiktok.com/ZSNMUNcrS/)
cd fbbrute
python2 jomblo.py
fi
...
figlet -f slant "W A I T"|lolcat
sleep 1
(xdg-open https://youtube.com/shorts/9k9szEtUPZw?si=lpSfEU1_vM-IcovY)
fi
...
figlet -f slant "W A I T"|lolcat
sleep 1
(xdg-open https://discord.com/invite/M3H6RYpu)
fi
